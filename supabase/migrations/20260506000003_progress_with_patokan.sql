-- Update RPC get_public_guru_progress: tambah patokan_bank_total
-- Progress = (submitted + approved + needs_revision) / patokan_bank_total
...
AS $$
  ...
  GROUP BY p.id, p.nama, p.kelas, mp.id, mp.nama, mp.kode
