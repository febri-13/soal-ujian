        ...
        <div className="hidden lg:flex flex-col justify-between py-8 px-4">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="font-bold text-sm leading-tight" style={{ color: "var(--pp-ink)" }}>
                Panel Administrasi PSAT Al Abidin
              </div>
              <div className="text-xs mt-0.5" style={{ color: "var(--pp-muted)" }}>
                Kelola soal, pengguna, dan konfigurasi sistem
              </div>
            </div>
          </div>
          ...
          <div>
            <h1 className="font-display font-semibold mb-3.5" style={{
              ...
              Pusat kendali{" "}
              <em style={{ fontStyle: "italic", color: "var(--pp-primary)" }}>bank soal</em>{" "}
              PSAT.
            </h1>
            <p style={{ fontSize: "17px", color: "var(--pp-ink-2)", lineHeight: 1.55, maxWidth: "480px" }}>
              Akses panel admin untuk mengelola pengguna, mata pelajaran, patokan soal, dan konfigurasi bobot nilai.
            </p>
            ...
            <div className="mt-6 flex flex-col gap-3.5">
              <div className="flex items-center gap-3.5 p-3.5" style={{
                ...
                <div style={{
                  ...
                  backgroundColor: "var(--pp-lilac)", color: "#4C1D95",
                ...
                <div>
                  ...
                  <div className="text-xs mt-0.5" style={{ color: "var(--pp-muted)" }}>
                    Tambah akun guru & validator, atur role, dan assignment mapel
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3.5 p-3.5" style={{
                ...
                <div>
                  <div className="font-semibold text-sm" style={{ color: "var(--pp-ink)" }}>
                    Konfigurasi Patokan & Bobot
                  </div>
                  <div className="text-xs mt-0.5" style={{ color: "var(--pp-muted)" }}>
                    Atur target soal per mapel dan bobot nilai per tipe & kesulitan
                  </div>
                </div>
              </div>
            </div>
          ...
          <blockquote className="font-display" style={{
            ...
            borderLeft: "3px solid var(--pp-lilac)",
            paddingLeft: "14px", paddingTop: "6px", paddingBottom: "6px",
            maxWidth: "440px", margin: 0,
          }}>
            &ldquo;Sistem penilaian yang baik bukan hanya soal angka — tapi tentang keadilan dan keterbacaan.&rdquo;
            <strong style={{
        ...
        <div className="flex items-center justify-center">
          <div className="w-full" style={{ maxWidth: "460px" }}>
            ...
            <div className="flex items-center gap-3 mb-6 lg:hidden">
              ...
              <div>
                <div className="font-bold text-sm" style={{ color: "var(--pp-ink)" }}>Panel Admin PSAT</div>
                <div className="text-xs" style={{ color: "var(--pp-muted)" }}>Akses terbatas</div>
              </div>
            </div>
            ...
            <div className="relative shadow-hard-lg" style={{
              ...
              <p className="mb-7 mt-1.5" style={{ fontSize: "14px", color: "var(--pp-muted)" }}>
                Gunakan akun admin yang sudah dikonfigurasi.
              </p>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="admin@alabidin.sch.id"
                      autoComplete="email"
                      spellCheck={false}
                      required
                      style={{
                ...
                >
                  {loading ? "Memuat..." : "Masuk ke panel admin"}
              ...
              <p className="text-center" style={{ fontSize: "13px", color: "var(--pp-ink-2)" }}>
                Bukan admin?{" "}
                <a href="/login" style={{ color: "var(--pp-primary)", fontWeight: 600, textDecoration: "underline", textUnderlineOffset: "3px" }}>
                  Login sebagai Guru / Validator
                </a>
              </p>
